...
class FrankaPlaying(BaseTask):
    ...
    def set_up_scene(self, scene):
        ...
        self.obj_actual_rot = self.object_start_pose[:3, :3]
        self.obj_actual_loc = self.object_start_pose[:3, -1]
...
parser.add_argument('--start-pose-file', type=str, required=True)

args = parser.parse_args()
object_start_pose = pickle.load(open(args.start_pose_file, "rb"))
