...
python grounded_sam_demo_backsub2.py --config GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py --grounded_checkpoint groundingdino_swint_ogc.pth --sam_checkpoint sam_vit_h_4b8939.pth --input_image_dir $ds_path/val  --output_dir $out_path/val --box_threshold 0.3 --text_threshold 0.25 --text_prompt "$prompt" --device "cuda" --no-morph
