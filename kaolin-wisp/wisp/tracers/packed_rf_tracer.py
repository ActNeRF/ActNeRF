...
class PackedRFTracer(BaseTracer):
    ...
    def trace(self, nef, rays, channels, extra_channels,
        ...
        tau = density * deltas
        del density, deltas
        ray_colors, transmittance, ray_epistemic, ray_epistemic2 = spc_render.exponential_integration(color, tau, boundary, exclusive=True)
        ...
        epistemic = torch.zeros(N, 1, device=rays.origins.device)
        epistemic2 = torch.zeros(N, 1, device=rays.origins.device)
        epistemic[ridx_hit] = ray_epistemic
        epistemic2[ridx_hit] = ray_epistemic2
        ...
        for channel in extra_channels:
            ...
            ray_feats, transmittance, _, _ = spc_render.exponential_integration(
        ...
        return RenderBuffer(depth=depth, hit=hit, rgb=rgb, alpha=out_alpha, epistemic=epistemic, epistemic2 = epistemic2, **extra_outputs)
