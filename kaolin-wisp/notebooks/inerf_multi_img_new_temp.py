...
# c2w_prev_estimated = pickle.load(open(f'{args.output}/c2w_estimated.pkl', 'rb'))
# c2w_prev_estimated[:3, 3] *= translation_scale.numpy()
# c2w_prev_estimated[:3, 3] += translation_offset.numpy()
# base_position = c2w_prev_estimated[:3, -1]
# base_rotation = c2w_prev_estimated[:3, :3]
