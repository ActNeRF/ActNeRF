...
def main(output_dump_dir, ranges, pipelines, object_center, robot_poses, mean_unc, nerf2ws, move_lambda, unc_lambda):
    ...
    best_cam = None
    min_loss = np.inf
    initial_pose, mean_unc = random_sampling(mean_unc)
...
if __name__ == '__main__':
    ...
    if not flip_possible:
        ...
        nbp, loss, mean_unc, best_image_no_flip, move_loss_no_flip = main(output_dump_dir, ranges, pipelines, object_center, robot_poses, None, nerf2ws_base, args.move_lambda, args.unc_lambda)
        ...
        nbp_flip, loss_flip, mean_unc_flip, best_image_flip, move_loss_flip = main(output_dump_dir, ranges, pipelines, object_center, robot_poses, None, nerf2ws_flip, args.move_lambda, args.unc_lambda)
