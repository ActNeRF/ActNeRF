...
# model_name = "cheezit_single_side_env2_nobg_sam_scale10"
    ...
    for i in range(1,6):
        ...
        model_path = os.path.join(model_dir, list(sorted(os.listdir(model_dir)))[-2], "model.pth")
        print(model_path)
    ...
    def random_sampling(pop_size=100, num_candidates_to_select=10, angle_diff_th=20):
