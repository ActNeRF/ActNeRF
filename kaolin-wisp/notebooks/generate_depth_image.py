...
# folder = "/home/saptarshi/dev/anygrasp/anygrasp_sdk/grasp_detection/cheezit5"
print('output_dir : ', output_dir)
os.makedirs(output_dir, exist_ok=True)
print(os.listdir(output_dir))
cv2.imwrite(f'{output_dir}/color.png', cv2.cvtColor((rgb*255.).astype(np.uint8), cv2.COLOR_RGB2BGR))

# bp()

Image.fromarray((depth * 1000 / 6 * 1.25).astype(np.int32), 'I').save(f'{output_dir}/depth.png')
pickle.dump(c2w_unscaled.detach().cpu().numpy(), open(f'{output_dir}/c2w.pkl', 'wb'))