...
import skimage
import cv2
from utils import config_parser, load_blender, show_img, find_POI, img2mse, load_llff_data, angle_between_rotation_matrices
    ...
    for k in range(1000):
        ...
        if (k + 1) % 20 == 0 or k == 0:
            ...
            with torch.no_grad():
                ...
                rot_error = angle_between_rotation_matrices(pose_dummy[:3,:3], obs_img_pose[:3,:3])
